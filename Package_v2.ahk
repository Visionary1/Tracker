...
Package := new OW()
Package.RegisterCloseCallback(Func("Terminate"))
Return
...
{
	__New() {
		Window := {Width: 500, Height: 300, Title: "OW Test", StatusBarText: "Haha"}
